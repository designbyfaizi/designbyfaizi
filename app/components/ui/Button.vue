...
const buttonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center leading-none text-base font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 ring-2 ring-transparent hover:ring-primary/20",
        soft: "bg-card border border-secondary-foreground/10  text-secondary-foreground hover:bg-secondary/90 ring-2 ring-transparent hover:ring-secondary-foreground/20",
        destructive:
